...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p>We received a request to change the email address on your <strong>Rapid Rescue</strong> account to this address. To confirm this change, please use the verification code below:</p>
            <div class="code-box">
                <span>{{ $code }}</span>
            </div>
            <div class="note">
            ...
            <p>If you did not request an email address change on your Rapid Rescue account, please ignore this email. Your current email address will remain unchanged.</p>
        </div>
        <div class="footer">
