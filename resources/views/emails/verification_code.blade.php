...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p>Thank you for registering with <strong>Rapid Rescue</strong>. To complete your account setup, please use the verification code below:</p>
            <div class="code-box">
                <span>{{ $code }}</span>
            </div>
            <div class="note">
            ...
            <p>If you did not create an account with Rapid Rescue, you can safely ignore this email.</p>
        </div>
        <div class="footer">
