...
<head>
    ...
    <title>Emergency Request Received</title>
    <style>
        ...
        .rreb-badge { display: inline-block; background: #fef2f2; border: 1px solid #fca5a5; color: #c0392b; font-weight: 700; font-size: 16px; padding: 6px 16px; border-radius: 8px; letter-spacing: 0.04em; margin-bottom: 20px; }
        ...
        .summary-label { color: #6b7280; font-weight: 600; min-width: 110px; flex-shrink: 0; }
        .summary-value { color: #1f2937; }
        .status-badge { display: inline-block; background: #fef9c3; border: 1px solid #fde68a; color: #92400e; font-size: 12px; font-weight: 700; padding: 2px 10px; border-radius: 20px; text-transform: uppercase; letter-spacing: 0.05em; }
        .alert-box { background: #fff7ed; border-left: 4px solid #f97316; border-radius: 6px; padding: 14px 18px; margin: 20px 0; }
        .alert-box p { color: #7c2d12; font-size: 14px; margin: 0; line-height: 1.5; }
...
<body>
    <div class="wrapper">
        <div class="header">
            <h1>🚑 Rapid Rescue</h1>
            <p>Emergency Dispatch System · Automated Notification</p>
        </div>
        <div class="body">
            <p>Your emergency request has been <strong>successfully received</strong>. Our dispatch team has been notified and will assign an ambulance as soon as possible.</p>
            ...
            <div class="summary-box">
                ...
                <div class="summary-row">
                    ...
                    <span class="summary-value"><span class="status-badge">Pending Dispatch</span></span>
                </div>
                <div class="summary-row">
                ...
                <div class="summary-row">
                    ...
                    <span class="summary-value">{{ $emergencyRequest->mobile_no }}</span>
                </div>
                <div class="summary-row">
                    <span class="summary-label">Submitted</span>
                    <span class="summary-value">{{ $emergencyRequest->created_at->format('d M Y, h:i A') }}</span>
                </div>

                @if($emergencyRequest->driver)
                <div style="margin-top:16px; padding-top:16px; border-top:1px solid #e5e7eb;">
                    <div class="summary-title">Assigned Driver</div>
                    <div class="summary-row">
            ...
            <div class="alert-box">
                <p>🚨 <strong>Keep your phone available.</strong> Our dispatch team or driver may contact you on <strong>{{ $emergencyRequest->mobile_no }}</strong> for coordination.</p>
            </div>

            <div class="cta">
                <a href="{{ url('/tracking/' . $emergencyRequest->id) }}">View Rapid Rescue →</a>
            </div>
        </div>
        <div class="footer">
